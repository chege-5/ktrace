...
const BuyerHeader = () => {
  ...
  const navItems = [
    { path: "/buyer/marketplace", label: "Marketplace", icon: <ShoppingCart className="h-4 w-4 mr-1" /> },
    { path: "/buyer/orders", label: "Orders", icon: <Package className="h-4 w-4 mr-1" /> },
    { path: "/buyer/reports", label: "Reports", icon: <BarChart3 className="h-4 w-4 mr-1" /> },
  ];
    ...
    <header className="bg-green-50 border-b border-green-200 shadow-soft sticky top-0 z-40">
      <div className="container mx-auto flex justify-between items-center h-16 px-4">
        <Link to="/" className="flex items-center space-x-3">
          ...
          <span className="text-2xl font-bold text-green-800">KahawaTrace Buyer</span>
        </Link>
